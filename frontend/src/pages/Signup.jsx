...
const Signup = () => {
  ...
  const handleFileInputChange = async (event) => {
    ...
    // for the mean time used the console
    // check to see if it does uploads
    console.log(file)
  };
          ...
          <div className='rounded-l-lg lg:pl-16 py-10'>
            ...
            <form onSubmit={submitHandler}>
              ...
              <div className='mb-5 flex items-center gap-3'>
                <figure className='w-[60px] h-[60px] rounded-full border-2 boder-solid border-primaryColor
                ...
                <div className='relative w-[130px] h-[50px]'>
                  ...
                  text-headingColor font-semibold rounded-lg truncate cursor-pointer'>Upload Photo
                  </label>
                </div>
              </div>
